...
// The upstream API silently caps every response at 1,000 rows even when a
// larger numOfRows is requested.  Page using the real cap so totalCount is
// converted to the correct number of requests.
const PER = 1000;
